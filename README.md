...
SBT config:
    ...
    libraryDependencies += "com.datastax.spark" %% "spark-cassandra-connector" % "1.2.0-rc1"

If you want to access the functionality of Connector from Java, you may want to add also a Java API module:

    libraryDependencies += "com.datastax.spark" %% "spark-cassandra-connector-java" % "1.2.0-rc1"
