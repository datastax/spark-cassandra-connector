...
SBT config:
    ...
    libraryDependencies += "com.datastax.spark" %% "spark-cassandra-connector" % "1.0.2" withSources() withJavadoc()

If you want to access the functionality of Connector from Java, you may want to add also a Java API module:

    libraryDependencies += "com.datastax.spark" %% "spark-cassandra-connector-java" % "1.0.2" withSources() withJavadoc()
