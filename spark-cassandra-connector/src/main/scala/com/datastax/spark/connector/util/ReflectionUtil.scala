...
object ReflectionUtil {
  ...
  def constructorParams[T : TypeTag]: Seq[(String, Type)] = constructorParams(implicitly[TypeTag[T]].tpe)
  ...
  def getters[T : TypeTag]: Seq[(String, Type)] = getters(implicitly[TypeTag[T]].tpe)
  ...
  def setters[T : TypeTag]: Seq[(String, Type)] = setters(implicitly[TypeTag[T]].tpe)
