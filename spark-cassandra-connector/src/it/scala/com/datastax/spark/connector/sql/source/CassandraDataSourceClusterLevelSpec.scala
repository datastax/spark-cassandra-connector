...
class CassandraDataSourceClusterLevelSpec  extends SparkCassandraITFlatSpecBase {
  ...
  override def beforeAll() {
    ...
    sqlContext.addClusterLevelCassandraConnConf("cluster1", CassandraConnectorConf(conf1))
    ...
    sqlContext.addClusterLevelCassandraConnConf("cluster2", CassandraConnectorConf(conf2))
