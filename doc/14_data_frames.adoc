...
These documents are relevant to Spark 3.0 and the SCC 3.0 and Greater
Please See link:data_source_v1.md[Datasource V1] for documentation of
Older Versions

Datasets provide a new API for manipulating data within Spark. These
...
[[extensions-spark-25-and-greater]]
...
Cassandra Catalogs see link:1_connecting.md[documentation on Connecting]
...
Creating a keyspace in a Cassandra Catalog can be done via SparkSQL. The
...
the older link:data_source_v1.md[Datasource V1] which is all still valid
for configuration.

link:15_python.md[Next - Python DataFrames]
