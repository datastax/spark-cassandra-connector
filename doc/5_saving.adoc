...
link:4_mapper.md#Mapping-User-Defined-Types[Case Class] or a
...
link:reference.md#write-tuning-parameters[Write Tuning Parameters]

link:6_advanced_mapper.md[Next - Customizing the object mapping]
