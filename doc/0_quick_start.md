...
Spark Driver and all Spark Executors.
    ...
    $SPARK_HOME/bin/spark-shell --packages datastax:spark-cassandra-connector:2.3.2-s_2.11
    $SPARK_HOME/bin/spark-submit --packages datastax:spark-cassandra-connector:2.3.2-s_2.11
