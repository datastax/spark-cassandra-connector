...
object TypeConverter {
  ...
  implicit object BooleanConverter extends TypeConverter[Boolean] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to Boolean")
    }
  }
  ...
  implicit object IntConverter extends TypeConverter[Int] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to Int")
    }
  }
  ...
  implicit object LongConverter extends TypeConverter[Long] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to Long")
    }
  }
  ...
  implicit object FloatConverter extends TypeConverter[Float] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to Float")
    }
  }
  ...
  implicit object DoubleConverter extends TypeConverter[Double] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to Double")
    }
  }
  ...
  implicit object ByteBufferConverter extends TypeConverter[ByteBuffer] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to ByteBuffer")
    }
  }
  ...
  implicit object ByteArrayConverter extends TypeConverter[Array[Byte]] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to Array[Byte]")
    }
  }
  ...
  implicit object DateConverter extends TypeConverter[Date] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to java.util.Date.")
    }
  }
  ...
  implicit object SqlDateConverter extends TypeConverter[java.sql.Date] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to java.sql.Date.")
    }
  }
  ...
  implicit object JodaDateConverter extends TypeConverter[DateTime] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to org.joda.time.DateTime.")
    }
  }
  ...
  implicit object BigIntConverter extends TypeConverter[BigInt] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to BigInt.")
    }
  }
  ...
  implicit object JavaBigIntegerConverter extends TypeConverter[java.math.BigInteger] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to java.math.BigInteger.")
    }
  }
  ...
  implicit object BigDecimalConverter extends TypeConverter[BigDecimal] {
    override def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to BigDecimal.")
    }
  }
  ...
  implicit object JavaBigDecimalConverter extends TypeConverter[java.math.BigDecimal] {
    def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to java.math.BigDecimal.")
    }
  }
  ...
  implicit object UUIDConverter extends TypeConverter[UUID] {
    override def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to UUID.")
    }
  }
  ...
  implicit object InetAddressConverter extends TypeConverter[InetAddress] {
    override def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to InetAddress.")
    }
  }
  ...
  class TupleConverter[K, V](implicit kc: TypeConverter[K], kv: TypeConverter[V])
    ...
    override def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Cannot convert object $x to a tuple.")
    }
  }

  class CollectionConverter[CC, T](implicit c: TypeConverter[T], bf: CanBuildFrom[T, CC])
    ...
    override def convert(obj: Any) = obj match {
      ...
      case x => throw new TypeConversionException(s"Object $x is not a collection.")
    }
  }
