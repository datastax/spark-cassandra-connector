...
public abstract class RDDAndDStreamCommonJavaFunctions<T> {
     ...
     * It additionally allows to specify a factory of custom {@link com.datastax.spark.connector.writer.RowWriter}.
     * By default, a factory of {@link com.datastax.spark.connector.writer.DefaultRowWriter} is used together with
     * underlying {@link com.datastax.spark.connector.mapper.JavaBeanColumnMapper}.
     * <p/>
     * If the underlying data source is a {@code DStream}, the method will make each generated RDD be saved
     * to Cassandra just like this method would be invoked on each such RDD.
     *
     ...
     * Saves the data from the underlying {@code RDD} or {@code DStream} to a Cassandra table.
     * This method works just like {@link #saveToCassandra(String, String)}.
     * It additionally allows to provide a custom column mapper. By default,
     ...
     * Saves the data from the underlying {@code RDD} or {@code DStream} to a Cassandra table.
     * This method works just like {@link #saveToCassandra(String, String)}.
     * It additionally allows to provide custom RDD object property mapping to columns in Cassandra table.
     * <p/>
     * Example:
     * <pre>
     ...
     * Saves the data from the underlying {@code RDD} or {@code DStream} to a Cassandra table.
     * This method works just like {@link #saveToCassandra(String, String, String[])}.
     * It additionally allows to provide custom RDD/DStream object property mapping to columns in Cassandra table.
     * <p/>
     * If the underlying data source is a {@code DStream}, the method will make each generated RDD be saved
     * to Cassandra just like this method would be invoked on each such RDD.
     *
