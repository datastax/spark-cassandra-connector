...
class JavaBeanColumnMapperTest {
  ...
  private val c1 = DefaultColumnDef("cassandra_property_1", PartitionKeyColumn, IntType)
  private val c2 = DefaultColumnDef("cassandra_camel_case_property", ClusteringColumn(0), IntType)
  private val c3 = DefaultColumnDef("flagged", RegularColumn, IntType)
  private val c4 = DefaultColumnDef("marked", RegularColumn, IntType)
  private val c5 = DefaultColumnDef("column", RegularColumn, IntType)
  private val c6 = DefaultColumnDef("nested", RegularColumn, u1)
  private val table1 = DefaultTableDef("test", "table", Seq(c1), Seq(c2), Seq(c3))
  private val table2 = DefaultTableDef("test", "table", Seq(c1), Seq(c2), Seq(c3, c4, c5))
  private val table3 = DefaultTableDef("test", "table", Seq(c1), Seq(c2), Seq(c6))
