...
public class CassandraRowTest {
    ...
    public void testGetBoolean() {
        CassandraRow row = new CassandraRow(new Object[]{true}, new String[]{"value"});
    ...
    public void testGetByte() {
        CassandraRow row = new CassandraRow(new Object[]{(byte) 1}, new String[]{"value"});
    ...
    public void testGetBytes() {
        CassandraRow row = new CassandraRow(new Object[]{new byte[]{1, 2, 3}}, new String[]{"value"});
    ...
    public void testGetDate() {
        ...
        CassandraRow row = new CassandraRow(new Object[]{new Date(t)}, new String[]{"value"});
    ...
    public void testGetDateTime() {
        long t = System.currentTimeMillis();
        CassandraRow row = new CassandraRow(new Object[]{new DateTime(t)}, new String[]{"value"});
    ...
    public void testGetDecimal() {
        CassandraRow row = new CassandraRow(new Object[]{new BigDecimal(123.321d)}, new String[]{"value"});
    ...
    public void testGetDouble() {
        CassandraRow row = new CassandraRow(new Object[]{123.321d}, new String[]{"value"});
    ...
    public void testGetFloat() {
        CassandraRow row = new CassandraRow(new Object[]{123.321f}, new String[]{"value"});
    ...
    public void testGetInet() throws Exception {
        CassandraRow row = new CassandraRow(new Object[]{InetAddress.getLocalHost()}, new String[]{"value"});
    ...
    public void testGetInt() {
        CassandraRow row = new CassandraRow(new Object[]{123}, new String[]{"value"});
    ...
    public void testGetLong() {
        CassandraRow row = new CassandraRow(new Object[]{123L}, new String[]{"value"});
    ...
    public void testGetShort() {
        CassandraRow row = new CassandraRow(new Object[]{(short) 123}, new String[]{"value"});
    ...
    public void testGetString() {
        CassandraRow row = new CassandraRow(new Object[]{"cassandra"}, new String[]{"value"});
    ...
    public void testGetUUID() {
        ...
        CassandraRow row = new CassandraRow(new Object[]{UUID.fromString(uuid)}, new String[]{"value"});
    ...
    public void testGetVarInt() {
        CassandraRow row = new CassandraRow(new Object[]{new BigInteger("123")}, new String[]{"value"});
    ...
    public void testGetObjectAndApply() {
        ...
        CassandraRow row = new CassandraRow(new Object[]{new TestClass(123)}, new String[]{"value"});
    ...
    @Test
    public void testGet() {
        CassandraRow row = new CassandraRow(new Object[]{"1"}, new String[]{"value"});
    ...
    public void testGetList() {
        CassandraRow row = new CassandraRow(new Object[]{Arrays.asList(1, 2, 3)}, new String[]{"value"});
    ...
    public void testGetSet() {
        CassandraRow row = new CassandraRow(new Object[]{Sets.newHashSet(1, 2, 3)}, new String[]{"value"});
    ...
    public void testGetMap() {
        ...
        map.put("one", 1);
        map.put("two", 2);
        CassandraRow row = new CassandraRow(new Object[]{map}, new String[]{"value"});
    ...
    public void testToMap() {
        CassandraRow row = new CassandraRow(new Object[]{"one", 1}, new String[]{"col1", "col2"});
